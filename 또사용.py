...
y_pred_ridge = ridge_regression()
res_data = pd.DataFrame({'Actural':y_test, 'Predicted': y_pred, 'Predicted_lasso' : y_pred_lasso, 'Predicted)ridge' : y_pred_ridge})   #비교를 위해 dataframe으로 만듬
